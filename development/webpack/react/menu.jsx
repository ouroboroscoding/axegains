...
class Menu extends React.Component {
	...
	render() {
		...
		return (
			<div id="menu">
				<div className={"menu_toggle" + (this.state.open ? ' open' : '')} onClick={this.toggle}>
					<i className="fas fa-bars" />
				</div>
				<div className={"menu_content" + (this.state.open ? ' open' : '')}>
					{self.state.thrower ?
						<div className="aright">
							<i className="fas fa-user link" title="Account" onClick={self.accountShow}></i>
							<i className="fas fa-power-off link" title="Sign Out" onClick={self.signout}></i>
						</div>
					:
						<div className="aright">
							<i className="fas fa-user-plus link" title="Create Account" onClick={self.signupShow}></i>
							<i className="fas fa-sign-in-alt link" title="Sign In" onClick={self.signinShow}></i>
						</div>
					}
					<ul className="one">
						<li>
						...
						<li>
							<span>WATL</span>
							<ul className="two">
								<li><a href="#org=watl&page=practice" onClick={this.close}>Practice</a></li>
								{self.state.thrower &&
									<React.Fragment>
										<li><a href="#org=watl&page=match" onClick={this.close}>Match</a></li>
										<li>
											<span>Stats</span>
											<ul className="three">
												<li><a href="#org=watl&page=stats&which=practice" onClick={this.close}>Practice</a></li>
												<li><a href="#org=watl&page=stats&which=match" onClick={this.close}>Match</a></li>
											</ul>
										</li>
									</React.Fragment>
								}
