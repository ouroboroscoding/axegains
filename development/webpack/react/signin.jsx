...
(function() {
	...
	APP.Components.Signin = React.createClass({
		...
		render: function() {
			return (
				<div id="signin" style={{"display": (this.state.visible ? 'block':'none')}}>
					{this.state.mode == 'signin' ?
						<form ref="signin" id="signin-form" action="/rest/signin" onSubmit={this.signin}>
							<input type="text" name="user[name]" placeholder="Name" /><br />
							<input type="password" name="user[passwd]" placeholder="Password" className="form-bottom" /><br />
							<div>
								<a href="#" onClick={this.signupShow}>Sign Up</a>
								<button type="submit" className="button">Sign In</button>
							</div>
						</form>
					:
						<form ref="signup" id="signup-form" action="/rest/signup" onSubmit={this.signup}>
							<input type="text" name="user[name]" placeholder="Name" /><br />
							<input type="text" name="user[email]" placeholder="Email (Optional)" /><br />
							<input type="password" name="user[passwd]" placeholder="Password" /><br />
							<input type="password" name="passwd-confirm" placeholder="Confirm Password" /><br />
							<div>
								<a href="#" onClick={this.signinShow}>Sign In</a>
