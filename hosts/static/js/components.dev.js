...
// Components
var Target = __webpack_require__(/*! ./natf/target.jsx */ "./react/natf/target.jsx"); // Export
...
function (_React$Component) {
  _inherits(NatfTarget, _React$Component);

  function NatfTarget(props) {
    var _this;

    _classCallCheck(this, NatfTarget);

    // Call the parent constructor
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NatfTarget).call(this, props)); // Initialise the state

    _this.state = {}; // Bind methods

    _this.scoreClick = _this.scoreClick.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(NatfTarget, [{
    key: "render",
